			...
			<div class="elementor-element elementor-element-e0cd736 elementor-widget elementor-widget-image" data-id="e0cd736" data-element_type="widget" data-widget_type="image.default">
				<div class="elementor-widget-container">
					<?php
    				    ...
    				    $user = $users_id ? $this->Admin_model->get_row_id('users',$users_id) : null;
            			$status = ($user && isset($user->status)) ? $user->status : '';
            			
						if(!empty($show->link)){
							$link = base_url().'uploads/admin/shows/folder/'.$show->folder.'/';
							$link = base_url().'uploads/admin/shows/folder/'.$show->folder.'/';
						}else{
						    
							$link = isset($show->link) ? $show->link : '#';
						}
					?>
				    ...
				    if($status == 'Active'){ 
				    ?>
					<a href="#"  data-toggle="modal" data-target="#myPaidModal">
...
<div id="myPaidModal" class="modal fade" role="dialog"  style="top:20%">
  <div class="modal-dialog">
    ...
    <div class="modal-content"style="background-color: #ffc000;">
      <div class="modalheader">
        <!--<button type="button" class="close" data-dismiss="modal">&times;</button>-->
        <center><h1 class="modal-title" style="font-family: agency_fbregular;margin-top:30px;"><b>Dette er en planlagt presentasjon</b></h1></center>
      </div>
      
       <div class="modalbody" align="center">
        <h3 style="font-family: agency_fbregular;margin-top: 6px;">og kan derfor ikke vises enda.</h3>
      </div>
      <div class="modalbody" align="center">
        <h3 style="font-family: agency_fbregular;margin-top: 6px;">Følg oppdateringene på infosiden</h3>
      </div>
      <div class="modalbody" align="center">
        <h3 style="font-family: agency_fbregular;margin-top: 6px;">for nærmere kunngjøring.</h3>
      </div>
