...
<h2 class="elementor-heading-title elementor-size-default" style="margin-left:1px;">Litterature</h2>		</div>
				</div>
					</div>
		</div>
							</div>
			...
			<article class="elementor-post elementor-grid-item post-1458 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
				<a class="elementor-post__thumbnail__link" href="<?php echo base_url().'home/blog_details/'.$blog['blogs_id']; ?>" tabindex="-1">
			<div class="elementor-post__thumbnail"><img fetchpriority="high" decoding="async" width="300" height="225" src="<?php echo base_url(); ?>uploads/admin/blogs/<?php echo $blog['f_image']; ?>" class="attachment-medium size-medium wp-image-1355" alt="" srcset="<?php echo base_url(); ?>uploads/admin/blogs/<?php echo $blog['f_image']; ?>  300w, <?php echo base_url(); ?>uploads/admin/blogs/<?php echo $blog['f_image']; ?> 1024w, <?php echo base_url(); ?>uploads/admin/blogs/<?php echo $blog['f_image']; ?> 768w, <?php echo base_url(); ?>uploads/admin/blogs/<?php echo $blog['f_image']; ?> 1200w" sizes="(max-width: 300px) 100vw, 300px"></div>
		</a>
				<div class="elementor-post__text">
				<h3 class="elementor-post__title">
			<a href="<?php echo base_url().'home/blog_details/'.$blog['blogs_id']; ?>">
