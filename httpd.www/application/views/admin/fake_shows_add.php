					...
					<div class="row">
						<div class="card col-md-12">
							...
							<div class="card-block">
								<form method="POST" action="<?php echo base_url().strtolower($this->session->userdata('role_name')); ?>/fake_shows_add/create"  enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-12">
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-sm-8 col-lg-10">
													<div class="input-group">
														<textarea name="description" required class="form-control textarea" id="editor1"  rows="6" placeholder="Enter text here..."></textarea>
													</div>
												</div>
											</div>
