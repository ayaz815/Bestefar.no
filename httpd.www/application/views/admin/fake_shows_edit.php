...
<?php $data = $this->Admin_model->get_row_id('fake_shows',$param2); ?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row ">
						...
						<div class="col-md-12">
							<form method="POST" action="<?php echo base_url().strtolower($this->session->userdata('role_name')); ?>/fake_shows/update"  enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-12">
											<div class="row">
												...
												<div class="col-sm-8 col-lg-10">
													<div class="input-group">
														...
														<input type="hidden" name="fake_shows_id" value="<?php echo $data->fake_shows_id; ?>">
